...
- 1台構成の場合は左右のどちらに取り付けても動作します 
  - BLE Micro Proを使う場合はコンスルーはUSBコネクタ側に寄せてください
...
- 上下の向きに注意して、トラックパッド用ICが基板上部に来る向きで取り付けてください 
...
### キースイッチ、電池を差し込む
- BLE Micro Pro 1台で動かす場合にはボードを取り付ける側のみに電池を入れるだけでも動きます
  - 左右両方にとりつけるとより長持ちします 
...
#### Pro Microの場合(暫定対応)
- QMK公式にはマージされていません。こちらのフォークからソースコードを取得してビルド、書き込みしてください                    